...
func TestSeparatePublicPages(t *testing.T) {
	...
	markers := map[string]string{"/": `id="hero-title"`, "/fotos-en-filmpjes": `data-library="training"`, "/oefeningen": `data-library="exercise"`, "/wie-zijn-wij": `class="members"`, "/bingo": `id="bingo-grid"`, "/playlists": `id="playlists-page"`}
