...
(() => {
  ...
  function setUser(value, canEdit = false) {
    ...
    document.querySelector('#account-permission').textContent = window.MCH.canEdit ? 'Je kunt oefeningen, het clubalbum, playlists en de bingo beheren.' : 'Dit account heeft geen beheerrechten.';
